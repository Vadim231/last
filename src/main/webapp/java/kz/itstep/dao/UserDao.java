...
public class UserDao extends AbstractDao<User> {
    ...
    private static final String SQL_SELECT_USERS_ALL = "SELECT * FROM users";
    private static final String SQL_INSERT_USER = "insert into users (login, name, password, roleId, surname) values(?, ?, ?, ?, ?)";
    private static final String SQL_DELETE_USER_BY_ID = "DELETE FROM users where id=?";
    private static final String SQL_UPDATE_USER = "UPDATE users set login=?, name=?, password=?, roleId=?, surname=? where id=?";
    private static final String SQL_SELECT_USER_BY_ID = "SELECT * FROM users where id=?";
    private static final String SQL_SELECT_USER_BY_LOGIN_PASSWORD = "SELECT * FROM users where login=? and password=?";
